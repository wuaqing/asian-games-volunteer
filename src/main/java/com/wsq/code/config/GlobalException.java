...
public class GlobalException {
    ...
    */
    ...
    @ExceptionHandler(value = NoProviderFoundException.class)
    public Result noProviderFoundException(HttpServletRequest request, NoProviderFoundException e){
        log.error(e.toString());
        return new Result().result500("出现excel错误",request.getRequestURI());
    }
